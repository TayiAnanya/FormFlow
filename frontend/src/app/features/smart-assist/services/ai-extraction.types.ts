...
export interface AILanguageModelProvider {
  ...
  /**
   * Free-form JSON generation from a prompt (no form schema).
   * Used by Smart Banking Advisor and similar conversational features.
   */
  generateStructuredJson(prompt: string): Promise<AIExtractionResult>;
}
